...
<p style="color: white; font-size: 20x; font-weight: bold; margin: 5px 0;">{activite}</p>
</div>
...
<p style="color: white; font-size: 20px; font-weight: bold; margin: 5px 0;">{transport}</p>
</div>
</div>
